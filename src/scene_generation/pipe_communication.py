...
class PipeCommunicationServer:
    ...
    def stop(self):
        """Request all server loops to stop on next iteration."""
        self._running = False

    def _cleanup_socket(self, address):
        """Clean stale Unix socket file before binding a listener."""
            ...
            try:
                ...
                while self._running:
                    ...
                    try:
                        ...
                        # Listener may become invalid after repeated failures; rebuild it.
    ...
    def start(self):
        """Start command listener and output sender in daemon threads."""
